        ...
        for (const number of numbers) {
            try {
                await sendWhatsAppMessage(
                    'Aagam8788',
                    'dhmag@9f',
                    'message_from_pahalgam_to_srinagar_houseboat',
                    number,
                    'image',
                    'aHR0cHM6Ly9hYWdhbS1ob2xpZGF5cy13ZWJzaXRlLW5ldy52ZXJjZWwuYXBwL2ltYWdlcy90ZW1wbGF0ZV9pbWFnZXMvcGFoYWxnYW1fdG9fc3JpbmFnYXJfaG91c2Vib2F0LmpwZw==',
                    'hi,aagamholidays',
                    'hi,hello'
                );
                setIsSent(true);
