        ...
        for (const number of numbers) {
            try {
                await sendWhatsAppMessage(
                    'Aagam8788',
                    'dhmag@9f',
                    'message_gulmarg_day_trip_reminder',
                    number,
                    'image',
                    'aHR0cHM6Ly9hYWdhbS1ob2xpZGF5cy13ZWJzaXRlLW5ldy52ZXJjZWwuYXBwL2ltYWdlcy90ZW1wbGF0ZV9pbWFnZXMvZ3VsbWFyZ19kYXlfdHJpcF9yZW1pbmRlci5qcGc=',
                    'hi,aagamholidays',
                    'hi,hello'
                );
                setIsSent(true);
