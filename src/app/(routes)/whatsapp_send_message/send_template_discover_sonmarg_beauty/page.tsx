        ...
        for (const number of numbers) {
            try {
                await sendWhatsAppMessage(
                    'Aagam8788',
                    'dhmag@9f',
                    'message_discover_sonmarg_beauty',
                    number,
                    'image',
                    'aHR0cHM6Ly9hYWdhbS1ob2xpZGF5cy13ZWJzaXRlLW5ldy52ZXJjZWwuYXBwL2ltYWdlcy90ZW1wbGF0ZV9pbWFnZXMvZGlzY292ZXJfc29ubWFyZ19iZWF1dHkuanBn',
                    'hi,aagamholidays',
                    'hi,hello'
                );
                setIsSent(true);
