       ...
       console.log('fetchData called');
        ...
        for (const number of numbers) {
             const params = new URLSearchParams({
                user_name: 'Aagam8788',
                password: 'dhmag@9f',
                template_name: 'message_discover_sonmarg_beauty',
                number: number,
                media_type: 'image',
                media_link: 'aHR0cHM6Ly9hYWdhbS1ob2xpZGF5cy13ZWJzaXRlLW5ldy52ZXJjZWwuYXBwL2ltYWdlcy90ZW1wbGF0ZV9pbWFnZXMvZGlzY292ZXJfc29ubWFyZ19iZWF1dHkuanBn',
